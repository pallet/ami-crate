...
$EDITOR resources/pallet_crate/ami_crate/meta.edn
$EDITOR doc-src/USAGE.md
lein crate-doc || exit 1
$EDITOR README.md
git add \
    resources/pallet_crate/ami_crate/meta.edn \
    doc-src/USAGE.md \
    doc-src/FOOTER.md \
    README.md \
...
&& git commit -m "Updated project.clj, and release notes for $version" \
